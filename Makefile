...
#    Updated: 2018/03/01 17:03:43 by msicot           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRC_NAME = ft_ls.c ft_parsing.c ft_print_nf.c ft_list_fx.c ft_println.c ft_flags.c ft_errors.c get_names.c ft_ls_0.c ft_recursive.c ft_path_check.c rm_node.c ft_listp.c ft_sortlist.c ft_print.c ft_option_l.c ft_types_l.c
